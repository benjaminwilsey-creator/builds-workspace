...
## Projects
- [rapid2_bot.md](Projects/rapid2_bot.md) — v1.3 live, QF mode, dust fix deployed ($5 floor + BEAM ignore) | account ~$90, must earn or shut down | paper review due 2026-05-08 | v1.4 survival-first design done, fine-tuning in Opus
...
- [autonomous_agent.md](Projects/autonomous_agent.md) — Lite Conductor: Track IDs + Spec/Acceptance required + phase checkpoints. Single-phase tracks chain through overnight without approval waits.
