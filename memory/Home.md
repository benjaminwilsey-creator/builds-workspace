# Second Brain — Benjamin Wilsey

This vault is shared between you and Claude Code. Claude reads these files at the start of every session to remember context, decisions, and project state.
